...
function fontsTask() {
  return src(files.fonts).pipe(dest(folders.fontsDist)); // Copies the font files to the dist fonts folder
}
// Cachebust Task:
...
exports.build = series(
  ...
  setBuildState,
  cleanTask,
  parallel(sassTask, jsTask, jQueryTask),
  parallel(htmlTask, imagesTask, fontsTask)
);
